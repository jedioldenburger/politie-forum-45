  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "text": "Welkom bij Politie Forum Nederland, het grootste online discussieplatform voor politie professionals, aspiranten, studenten criminologie, journalisten en geïnteresseerde burgers. Met meer dan 10.000 leden discussiëren wij dagelijks over actuele politie-onderwerpen, criminaliteit, forensische opsporing, justitie en veiligheid. Onze community biedt waardevolle inzichten, professionele expertise en een levendige uitwisseling van kennis over alle aspecten van de Nederlandse politie en rechtspraak.",
        "inLanguage": "nl-NL",
        "isPartOf": { "@id": "https://politie-forum.nl/#website" },
...
export function generateHowToVideoSchema() {
  return [
      ...
      },
      {
        ...
        "uploadDate": "2025-11-04T00:00:00+01:00",
        "duration": "PT1M",
